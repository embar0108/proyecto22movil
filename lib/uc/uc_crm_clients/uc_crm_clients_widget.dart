...
import 'uc_crm_clients_model.dart';
export 'uc_crm_clients_model.dart';

class UcCrmClientsWidget extends StatefulWidget {
  const UcCrmClientsWidget({super.key});

  @override
  State<UcCrmClientsWidget> createState() => _UcCrmClientsWidgetState();
}

class _UcCrmClientsWidgetState extends State<UcCrmClientsWidget>
    with TickerProviderStateMixin {
  late UcCrmClientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UcCrmClientsModel());
